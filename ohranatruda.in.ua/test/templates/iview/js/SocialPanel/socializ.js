function socializ(u,t) {
	var m1 = 61; /* расстояние от начала страницы до плавающей панели */
	var m2 = 20; /* расстояние от верха видимой области страницы до плавающей панели */
	var f = '/templates/gotovimvse/js/SocialPanel/img/'; /* путь к папке с изображениями кнопок */
	...
	$(function() {
		...
		s.append(
            '<a href="http://vk.com/share.php?url=' + u + '" title="Поделиться ВКонтакте"><img src="' + f + 'vkontakte.png" alt="" /></a>' +
