								...
								for (i = 0, len = option.length; i < len; i++) {
									...
									for (var k in data) {
										if (data[k] != '') dataList += ' data-' + k + '="' + data[k] + '"';
                                                                        ...
                                                                        var optionContent = option.eq(i).attr("data-real-content") ? option.eq(i).attr("data-real-content") : option.eq(i).text();
                                                                        optionContent = optionContent.replace(new RegExp("\\[",'g'),"<");
                                                                        optionContent = optionContent.replace(new RegExp("\\]",'g'),">");
									li = '<li' + dataJqfsClass + dataList + ' class="' + liClass + optionClass + '">'+ optionContent +'</li>';
