                ...
                <form id="new_poll_form">
                    ...
                    <xsl:if test="count(//images//item) &lt; 1">
                        <div class="form-group attach_photo">
                            <button class="btn btn-default btn upload_image" type="button" data-fragment="0" data-url="/vote/upload_image_poll/" data-parameters="" onclick="UploadImage('poll_new_image', $(this));">
                    ...
                    <form id="new_poll_form">
                        <div class="content">
                            ...
                            <xsl:if test="count(//images//item) &lt; 4">
                                <div class="form-group attach_photo">
                                    <button class="btn btn-default btn upload_image" type="button" data-fragment="" data-url="/vote/upload_image_poll/" data-parameters="" onclick="UploadImage('poll_new_image', $(this));">
                                        <span class="glyphicon glyphicon-paperclip"></span>
                                        Прикрепить фото
                                    </button>
                                </div>
